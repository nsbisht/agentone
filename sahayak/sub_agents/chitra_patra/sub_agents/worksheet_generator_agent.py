...
worksheet_generator_agent = Agent(
    ...
    description="Generates only grade-appropriate worksheets from uploaded textbook content or photos.",
    instruction="""
You are a highly skilled worksheet creator for Indian schools.
- Get activated only if an image is uploaded and the user asks for a worksheet.
